...
public class TestStreamTerminal {
    public static void main(String[] args) {
        ...
        // anyMatch
        boolean resultMatch = stringList.stream().allMatch(x -> x.equals("50"));
        ...
        // min, max
        System.out.println("min result for matching string : " + stringList.stream().min((o1, o2) -> o1.compareTo(o2)).get());
